...
* Kendall's $\tau_{\mathrm{b}}$ nimmt Werte zwischen null und eins an $(-1 \leq \tau_{\mathrm{b}} \leq 1)$. -1 impliziert die maximale negative Assoziation, 0 keine Assoziation und 1 die maximale positive Assoziation
* Nach Cohen [-@cohen1988], gilt $\tau =.1$ (bzw. $\tau = -.1$) als kleiner Effekt und $\tau =.3$ (bzw. $\tau = -.3$) und $\tau =.5$ (bzw. $\tau = -.5$) als  starker Effekt
:::

## Visual Guessing Kendall's $tau_b$ {.center}
<iframe id="guessingkendall" src="https://sammerk.shinyapps.io/Visual_Guessing_tau/" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" id="iframe_container" frameborder="0" ></iframe>
</center>
<style>
#guessingkendall {height: 500px; width: 900px; margin-top: 0.0cm; border:0px;}
</style>


## <!--Pearsons's r--> {.center .smaller}
[{{< fa ruler >}} Assoziation zweier normalverteilter Variablen]{.em15 .c .imp}
...
## Gleiche Daten - untersch. Steigung? {.center}
:::: {.columns}
...
<iframe id="guessingr" src="https://sammerk.shinyapps.io/Visual_Guessing_r/" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" id="iframe_container" frameborder="0" ></iframe>
</center>
<style>
#guessingr {height: 500px; width: 900px; margin-top: 0.0cm; border:0px;}
</style>
